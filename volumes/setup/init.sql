...
CREATE TABLE `PlanDexecution` (
  `id_planD` varchar(100) NOT NULL,
  `nombrDemployee` integer(100) NOT NULL,
  `duree` integer(100) NOT NULL,
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Index pour la table `projet`
--
ALTER TABLE `PlanDexecution`
  ADD PRIMARY KEY (`id_planD`);
COMMIT;
